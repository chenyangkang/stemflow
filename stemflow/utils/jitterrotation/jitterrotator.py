...
class JitterRotator:
    ...
    def inverse_jitter_rotate(cls, 
        ...
        back_jitter_data = np.array([np.array(x_array_rotated) - calibration_point_x_jitter, 
                                     np.array(y_array_rotated) - calibration_point_y_jitter]).T
