...
def test_mini(
    ...
    print("Temporary files will be stored at: ./tests/stemflow_mini_test/")
    if delet_tmp_files:
    ...
    if "mini_data.pkl" not in os.listdir("./tests/stemflow_mini_test"):
    ...
    for var_ in top_10_important_vars.index[:2]:
        ...
        make_sample_gif(
            importances_by_points,
            f"./tests/stemflow_mini_test/FTR_IPT_{var_}.gif",
            col=var_,
            log_scale=False,
            Spatio1="longitude",
            Spatio2="latitude",
